...
--
-- Table structure for table `os_lnk_resources_items`
--

DROP TABLE IF EXISTS `os_lnk_resources_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `os_lnk_resources_items` (
...
--
-- Dumping data for table `os_lnk_resources_items`
--
...
INSERT INTO `os_modules_data` VALUES ('05e94929-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:45:59','2018-03-20 16:45:59',1),('14a7b6b5-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:46:24','2018-03-20 16:46:24',1),('14dd7cbd-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:46:24','2018-03-20 16:46:24',1),('14f8fb24-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:46:25','2018-03-20 16:46:25',1),('1586b681-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:46:26','2018-03-20 16:46:26',1),('15dd1e83-2c45-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": null, \"detail\": {\"end\": \"2018-03-22T07:30\", \"uuid\": null, \"start\": \"2018-03-22T06:30\", \"title\": \"Test\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 16:46:26','2018-03-20 16:46:26',1),('17392a93-2c3e-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": \"17392a93-2c3e-11e8-adea-1866da0d8409\", \"detail\": {\"end\": \"2018-03-22T08:15\", \"uuid\": \"17392a93-2c3e-11e8-adea-1866da0d8409\", \"start\": \"2018-03-22T06:45\", \"title\": \"Testo\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 15:56:22','2018-03-20 15:56:22',1),('7177e5a0-2c60-11e8-adea-1866da0d8409','calendar','{\"id\": \"46\", \"uuid\": \"7177e5a0-2c60-11e8-adea-1866da0d8409\", \"detail\": {\"end\": \"2018-03-21T07:15\", \"uuid\": \"7177e5a0-2c60-11e8-adea-1866da0d8409\", \"start\": \"2018-03-21T07:00\", \"title\": \"ooo\"}, \"resource\": \"students\"}','[\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_STUDENTS\"]','2018-03-20 20:02:16','2018-03-20 20:02:16',1);
...
INSERT INTO `os_resources_items` VALUES (40,'schoolbus','{\"groupid\": \"01\"}','2018-03-20 13:37:59','2018-03-20 13:37:59','{\"can_read\": [\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_DE\"], \"can_write\": [\"ROLE_ADMIN\"]}',NULL,1),(42,'schoolbus','{\"groupid\": \"03\"}','2018-03-20 13:38:05','2018-03-20 13:38:05','{\"can_read\": [\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_DE\"], \"can_write\": [\"ROLE_ADMIN\"]}',NULL,1),(44,'schoolbus','{\"groupid\": \"05\"}','2018-03-20 13:38:11','2018-03-20 13:38:11','{\"can_read\": [\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_DE\"], \"can_write\": [\"ROLE_ADMIN\"]}',NULL,1),(46,'students','{\"name\": \"Bob\", \"birth\": \"2018-12-31\", \"email\": \"bob@gmail.com\", \"lastname\": \"Alice\", \"matricule\": \"001\"}','2018-03-20 15:02:58','2018-03-20 15:02:58','{\"can_read\": [\"ROLE_ADMIN\", \"ROLE_USER\", \"ROLE_DE\"], \"can_write\": [\"ROLE_ADMIN\"]}',48,1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_allowed_creating_roles`(roles JSON, search_field VARCHAR(20)) RETURNS text CHARSET utf8mb4
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_allowed_reading_roles`(roles JSON, search_field VARCHAR(20)) RETURNS text CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_allowed_roles`(roles JSON, search_field VARCHAR(20), jfield VARCHAR(20)) RETURNS text CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_allowed_writing_roles`(roles JSON, search_field VARCHAR(20)) RETURNS text CHARSET utf8mb4
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_get_json_string`(query JSON, jkey VARCHAR(20)) RETURNS text CHARSET utf8mb4
BEGIN
	SET @k = concat('$.', jkey);
    ...
    if os_is_json_null(@resource) then    
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `os_is_json_null` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  FUNCTION `os_is_json_null`(mdata VARCHAR(255)) RETURNS tinyint(1)
BEGIN
	IF (mdata is null OR mdata = '' OR mdata = 'null' OR mdata = CAST('null' AS JSON)) then
		return 1;
	ELSE	
		return 0;
	END IF;
...
BEGIN
	...
	END IF;
	IF NOT os_is_json_null(@parent_id) THEN
...
BEGIN
	...
	SELECT content FROM os_attachments a WHERE a.uuid = uuid AND sessions_id = sessions;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	IF @module = 'calendar' COLLATE utf8mb4_unicode_ci THEN
		set @query = CONCAT(
			'SELECT JSON_SET(md.data->''$.detail'', ''$.uuid'', md.uuid, ''$.id'', md.data->''$.id'') as data FROM os_modules_data md ',
		...
		PREPARE stmt FROM @query;
		EXECUTE stmt USING @module, @sessions, @module, @sessions;
		DEALLOCATE PREPARE stmt;
	ELSE
		set @query = CONCAT(
			'SELECT JSON_SET(md.data->''$.detail'', ''$.uuid'', md.uuid, ''$.id'', md.data->''$.id'') as data FROM os_modules_data md ',
...
BEGIN
	...
	set @query = CONCAT(
		'SELECT * FROM os_resources WHERE sessions_id = ?',
		' AND (', @swhere, ' )',
		' ORDER by position '
	);
	PREPARE stmt FROM @query;
...
BEGIN
    ...
    set @query = CONCAT(
		'SELECT fields as columns FROM os_resources WHERE name = ? AND sessions_id = ?',
...
BEGIN
	...
	ELSEIF NOT os_is_json_null(JSON_EXTRACT(query, '$.ids'))  THEN
	    ...
	    set @query = CONCAT(
			'SELECT  JSON_INSERT(params, ''$.id'', id) as data FROM os_resources_items WHERE ',
			' JSON_CONTAINS(?,  JSON_ARRAY(id) ) = 1 AND sessions_id = ? ',
			' AND (', @swhere, ' )'
		);
	    PREPARE stmt FROM @query;
	    EXECUTE stmt USING @queryparam, @sessions;
...
BEGIN
    ...
    set @query = CONCAT(
		'SELECT * FROM os_resources_features WHERE resources_name = ? AND active = 1 AND sessions_id = ? ',
		' AND (', os_allowed_reading_roles(roles, 'roles'), ' )'
	);	
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `os_get_resources_lnk` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `os_get_resources_lnk`(query JSON)
BEGIN
	DECLARE roles JSON default '[]';
	DECLARE r_id INTEGER default NULL;
	DECLARE sessions INT default 0;
	DECLARE r_name VARCHAR(20) default NULL;

	SET sessions = os_get_json_string(query , 'sessions');
	SET roles = os_get_json_roles(query); 
	SET r_id = os_get_json_string(query , 'id');
	SET r_name = os_get_json_string(query , 'resource_name');
	SET @r_type = os_get_json_string(query , 'type');
	SET @swhere = os_allowed_reading_roles(roles, 'roles');

	if @r_type = 'child' OR @r_type = 'children' then
		SELECT ri.resource, JSON_INSERT(ri.params, '$.id', id) as data
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `os_set_resources_lnk` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `os_set_resources_lnk`(query JSON)
BEGIN
	DECLARE roles JSON default '[]';
	DECLARE r_id INTEGER default NULL;
	DECLARE sessions INT default 0;
	...
	set @query = CONCAT(
		'SELECT roles INTO @items_roles FROM os_resources_items WHERE id = ', r_id ,' AND ',
		' (', os_allowed_writing_roles(roles, 'roles') , ' )'
	);
	PREPARE stmt FROM @query;
	EXECUTE stmt;
	...
	SET @r_type = null;
	IF NOT os_is_json_null(query->'$.parents') then
		SET @r_type = 'parents';
	ELSEIF NOT os_is_json_null(query->'$.children') then
		SET @r_type = 'children';
	end if;
	...
	if @r_type = 'children' then
		SELECT resource INTO r_name FROM os_resources_items WHERE id = JSON_EXTRACT(query->'$.children', '$[0]') AND sessions_id = sessions;
	elseif @r_type = 'parents' then
		SELECT resource INTO r_name FROM os_resources_items WHERE id = JSON_EXTRACT(query->'$.parents', '$[0]') AND sessions_id = sessions;
	end if;

	if (r_name is null) then
    	SIGNAL SQLSTATE '45000'
 		SET MESSAGE_TEXT = 'wrong_resource_name';			
	end if;

	START TRANSACTION;
	if @r_type = 'children' then
		DELETE FROM os_lnk_resources_items WHERE resource_name = r_name AND parent_id = r_id AND sessions_id = sessions;
	elseif @r_type = 'parents' then
		DELETE FROM os_lnk_resources_items WHERE resource_name = r_name AND resources_id = r_id AND sessions_id = sessions;
	end if;

	WHILE i < JSON_LENGTH( JSON_EXTRACT(query, CONCAT('$.', @r_type)) ) DO
		if @r_type = 'children' then
			INSERT INTO os_lnk_resources_items 
				SELECT DISTINCT r_id, JSON_EXTRACT(query->'$.children',CONCAT('$[',i,']')), sessions, ri.resource 
				FROM os_resources_items  ri
				WHERE ri.id =  JSON_EXTRACT(query->'$.children',CONCAT('$[',i,']'));
		elseif @r_type = 'parents' then
			INSERT INTO os_lnk_resources_items 
				SELECT DISTINCT JSON_EXTRACT(query->'$.parents',CONCAT('$[',i,']')), r_id, sessions, ri.resource
				FROM os_resources_items  ri
				WHERE ri.id =  JSON_EXTRACT(query->'$.parents',CONCAT('$[',i,']'));
		end if;
	    SELECT i + 1 INTO i;
	END WHILE;
	COMMIT;
	...
	if @r_type = 'children' then
		SELECT * FROM os_lnk_resources_items WHERE resource_name = r_name AND parent_id = r_id AND sessions_id = sessions;
	elseif @r_type = 'parents' then
		SELECT * FROM os_lnk_resources_items WHERE resource_name = r_name AND resources_id = r_id AND sessions_id = sessions;
	end if;
...
-- Dump completed on 2018-03-20 20:47:59
