...
--
/*!50003 DROP PROCEDURE IF EXISTS `get_resources` */;
...
DELIMITER ;;
CREATE DEFINER=`solofo`@`localhost` PROCEDURE `get_resources`()
BEGIN
    SELECT * FROM os_resources ORDER by position;
END ;;
DELIMITER ;
...
-- Dump completed on 2017-11-05 20:11:03
